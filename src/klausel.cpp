...
Klausel::Klausel(const unsigned int& klausel_id):
    klausel_id_(klausel_id), anz_variablen_(0) {}

//Attribute der Klausel ausgeben:
unsigned int Klausel::id() const {
    return klausel_id_;
}
...
const std::vector<unsigned int>& Klausel::var_positiv() const {
    return var_positiv_;
}

const std::vector<unsigned int>& Klausel::var_negativ() const {
    return var_negativ_;
}


//Variable hinzufuegen:
void Klausel::positive_var_hinzu(const unsigned int& var_id) {
    var_positiv_.push_back(var_id);
    anz_variablen_++;
}

void Klausel::negative_var_hinzu(const unsigned int& var_id) {
...
void Klausel::print() const {
    ...
    for (const int& var_id : var_positiv_) {
        std::cout << var_id << " ";
    }
    for (const int& var_id : var_negativ_) {
        std::cout << -var_id << " ";
    }
    std::cout << "\n";
}